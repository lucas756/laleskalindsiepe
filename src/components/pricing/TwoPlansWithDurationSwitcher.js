  ...
  const defaultPlans = [
    {
      name: "Avulso",
      durationPrices: ["R$50"],
      mainFeature: "1 hora avulsa",
      features: ["Software Ceramill", "Ceramill-Motion 2", "Impressão 3D", "Scanner de Alto Desempenho", "Bancadas para finalização", "Fornos de injeção, queima e sinterização"],
      time: "Hora"
    },
    {
      name: "Semanal",
      durationPrices: ["R$230"],
      mainFeature: "1 hora por dia da semana, 5 horas no total",
      features: ["Software Ceramill", "Ceramill-Motion 2", "Impressão 3D", "Scanner de Alto Desempenho", "Bancadas para finalização", "Fornos de injeção, queima e sinterização"],
      time: "Semanal"
    },
    {
      name: "Mensal",
      durationPrices: ["R$900"],
      mainFeature: "1 hora por dia da semana, 22 horas no total",
      features: ["Software Ceramill", "Ceramill-Motion 2", "Impressão 3D", "Scanner de Alto Desempenho", "Bancadas para finalização", "Fornos de injeção, queima e sinterização"],
      time: "Mensal"
    }
  ];
            ...
            <Plan key={index} featured={plan.featured}>
              <PlanHeader>
                <span className="priceAndDuration">
                  ...
                  <span className="duration">{plan.time}</span>
                </span>
